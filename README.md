...
The assignment originally required using localStorage, but I decided to use a backend instead, as this approach was allowed by the instructor. This allowed me to integrate the React frontend with the existing Web API and SQL Server database.
